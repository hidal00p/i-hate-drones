...
class VelocityAviary(BaseAviary):
    ...
    def _action_space(self):
        ...
        act_lower_bound = np.array([[-1, -1, -1, 0] for _ in range(self.NUM_DRONES)])
        act_upper_bound = np.array([[1, 1, 1, 1] for _ in range(self.NUM_DRONES)])
    ...
    def _compute_obs(self):
        ...
        For the value of the state, see the implementation of `_get_drone_state_vector()`.
